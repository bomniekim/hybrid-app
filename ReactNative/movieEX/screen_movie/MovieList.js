...
export default class MovieList extends Component{
    ...
    // 네비게이션 headerBar(액션바)의 옵션적용[re-run해야 함]
            ...
            headerLeft: ()=>{
                return <TouchableOpacity
                            ...
                            onPress={ async ()=>{
                                ...
                                // AsyncStorage에서 로그인 상태 변경
                                await AsyncStorage.removeItem('isLogin');
                                // 비동기를 동기식처럼 쓰도록 (thread의 능력을 잠시 stop)
