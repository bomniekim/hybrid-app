...
export default class MainComponent extends Component{
    ...
    render(){
        return(
            ...
            // 4-3) TouchableNativeFeedback: only for Android
            ...
            // 4-4) TouchableWithoutFeedback: 클릭 시 아무런 효과가 발생하지 않도록
            ...
            // 6) ScrollView: content가 많은 경우
            // <ScrollView>
            //     <Image source={require('./images/ben1jpg')} sytle={{width:120, height:100, margin:8}}></Image>
            //     <Image source={require('./images/ben2.jpg')} sytle={{width:120, height:100, margin:8}}></Image>
            //     <Image source={require('./images/ben3.jpg')} sytle={{width:120, height:100, margin:8}}></Image>
            //     <Image source={require('./images/pengsoo.jpg')} sytle={{width:120, height:100, margin:8}}></Image>
            //     <Image source={require('./images/pengsoo2.jpg')} sytle={{width:120, height:100, margin:8}}></Image>
            //     <Image source={require('./images/pengsoo3.jpg')} sytle={{width:120, height:100, margin:8}}></Image>
            // </ScrollView>


            // 7) 배경이미지 적용하기 (css의 background-image)
            // <ImageBackground> 사용
            // <View>
